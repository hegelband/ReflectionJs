...
describe("getArgumentDefaultValue", function () {
	...
	describe("getStringifiedEntityName('')", function () {
		it(`should throw an exception 'getStringifiedEntityName argument is an empty string.`, function () {
			const testFuncThrowsError = () => getStringifiedEntityName("");
			assert.throws(testFuncThrowsError, Error, `getStringifiedEntityName argument is an empty string.`);
		});
	});
